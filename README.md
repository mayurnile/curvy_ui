## Curvy UI
### An example usage of curves in a application
...
1. Clone the project by command
    ```
        git clone https://github.com/mayurnile/curvy_ui
    ```
1.  Execute the app!
...
Project Link: [https://github.com/mayurnile/curvy_ui](https://github.com/mayurnile/curvy_ui)